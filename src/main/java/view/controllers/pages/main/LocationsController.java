...
public class LocationsController implements ControllerAware {
    ...
    private void handleNew() {
        if (resolveIsNotSaved()) {
            ...
            alert.setContentText("Are you sure you want to create a new location?\n" +
    ...
    private boolean resolveIsNotSaved() {
        if (isEditingMode) {
            ...
            return !nameTextField.getText().equals(savedName) || !buildingTextField.getText().equals(savedBuilding) || !campusTextField.getText().equals(savedCampus);
        } else {
            return !nameTextField.getText().isEmpty() || !buildingTextField.getText().isEmpty() || !campusTextField.getText().isEmpty();
        }
    }
